...
<div class="card card-primary shadow-sm">
	<div class="card-header">
		<h3 class="card-title"><i class="fas fa-plus-circle mr-2"></i> Create New Cashflow</h3>
	</div>
	<form id="createCashflowForm" action="{{ route('cashflow.store') }}" method="post" novalidate>
		@csrf
		<div class="card-body">
			<div class="row">
				<div class="col-sm-6">
...
<script>
	document.getElementById('createCashflowForm').addEventListener('submit', function(e) {
		e.preventDefault();
		...
		Swal.fire({
			title: 'Yakin ingin menambahkan data cashflow?',
			icon: 'question',
